...
public class RemoveMVhandler extends AbstractHandler {

	public RemoveMVhandler() {
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		/*
		 * RenameWarninghandler.java void open(String titleName, boolean
		 * previewCheck, String var, String windowName)
		 */
		RenameWarninghandler rw = new RenameWarninghandler();
		rw.open(textCheckPage.RemoveMV, true, "null", "Warning");
